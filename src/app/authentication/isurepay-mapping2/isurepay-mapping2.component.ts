...
import { iSureMappingService } from '../isure-pay-mapping/isuremapping.service'
...
@Component({
  selector: 'app-isurepay-mapping2',
  templateUrl: './isurepay-mapping2.component.html',
  styleUrls: ['./isurepay-mapping2.component.css'],
  providers: [iSureMappingService]
})
export class IsurepayMapping2Component implements OnInit {
  // <!-- ####### changes by sanchita 16-December-2019 For Display -->
  ...
  //mapping object
  public iSureMapping2RequestObject1 = [];
  public tempiSureMapping2RequestObject1Data = [];
  public iSureMapping2ResponseObject1 = [];
  public tempiSureMapping2ResponseObject1Data = [];
  public iSureMapping2RequestObject2 = [];
  public tempiSureMapping2RequestObject2Data = [];
  public iSureMapping2ResponseObject2 = [];
  public tempiSureMapping2ResponseObject2Data = [];
  ...
  constructor(private makerService: MakerService, private mappingService: iSureMappingService, private modalService: NgbModal,
  ...
  ngOnInit() {
    ...
    //calling after getProjecta function
    this.mappingService.getMappingData(this.projectId).then((getMappingDataResult) => {
      ...
      if (getMappingDataResult.length) {
        if (getMappingDataResult[0].mappingObj) {
          ...
          this.tempiSureMapping2RequestObject1Data = getMappingDataResult[0].mappingObj.iSureMapping2RequestObject1;
          this.tempiSureMapping2ResponseObject1Data = getMappingDataResult[0].mappingObj.iSureMapping2ResponseObject1;
          this.tempiSureMapping2RequestObject2Data = getMappingDataResult[0].mappingObj.iSureMapping2RequestObject2;
          this.tempiSureMapping2ResponseObject2Data = getMappingDataResult[0].mappingObj.iSureMapping2ResponseObject2;
  ...
  getICICIRequestResponseData() {
    ...
    var service = "iSurePay-Real Time Cheque and Cash Collection Two Level Validation at Client and Bank’s End"
  ...
  bindDataToRequest1Data() {
    console.log("tempiSureMapping2RequestObject1Data ====>", this.tempiSureMapping2RequestObject1Data.length)
    if (this.tempiSureMapping2RequestObject1Data.length === 0) {
      this.requestData = this.removeDup(this.requestDataBefore);
    } else {
      this.requestData = this.tempiSureMapping2RequestObject1Data;
    }
  }
  ...
  bindDataToResponse1Data() {
    console.log("tempiSureMapping2ResponseObject1Data ====>", this.tempiSureMapping2ResponseObject1Data.length)
    if (this.tempiSureMapping2ResponseObject1Data.length === 0) {
      this.responseData = this.removeDup(this.responseDataBefore)
    } else {
      this.responseData = this.tempiSureMapping2ResponseObject1Data;
    }
  }
  ...
  bindDataToRequest2Data() {
    console.log("tempiSureMapping2RequestObject2Data ====>", this.tempiSureMapping2RequestObject2Data.length)
    if (this.tempiSureMapping2RequestObject2Data.length === 0) {
      this.requestData2 = this.removeDup(this.requestData2Before);
    } else {
      this.requestData2 = this.tempiSureMapping2RequestObject2Data;
    }
  }
  ...
  bindDataToResponse2Data() {
    console.log("tempiSureMapping2ResponseObject2Data ====>", this.tempiSureMapping2ResponseObject2Data.length)
    if (this.tempiSureMapping2ResponseObject2Data.length === 0) {
      this.responseData2 = this.removeDup(this.responseData2Before);
    } else {
      this.responseData2 = this.tempiSureMapping2ResponseObject2Data;
    }
  }
...
*/
  ...
  */
  ...
  deleteValueRequest2(data) {
    for (var q = 0; q < this.requestData2.length; q++) {
      if (this.requestData2[q].sfieldName == data.sfieldName && this.requestData2[q].tfieldName == data.tfieldName) {
...
*/
  ...
  deleteValueResponse12(data) {
    ...
    for (var q = 0; q < this.responseData2.length; q++) {
      if (this.responseData2[q].sfieldName == data.sfieldName && this.responseData2[q].tfieldName == data.tfieldName) {
...
if(this.ansName== false){
  ...
  console.log(" not empty");
    ...
    this.iSureMapping2RequestObject1 = this.requestData;
    this.iSureMapping2ResponseObject1 = this.responseData;
    ...
    this.iSureMapping2RequestObject2 = this.requestData2;
    this.iSureMapping2ResponseObject2 = this.responseData2;
    ...
    console.log("expectObjRequest2 = ", expectObjRequest2)
    ...
    console.log("expectObjResponse2 = ", expectObjResponse2)
    ...
    if (mandatoryFlag2 == true) {
      ...
      this.yamlCreation2(this.requestData2, this.responseData2, clientUrl);
      ...
      for (var u = 0; u < this.combinedDataAfterExtractionSourceResponse.length; u++) {
        if (this.combinedDataAfterExtractionSourceResponse[u].key.includes(this.dataWithDirectRowNo[y].sourceFieldName)) {
          for (var a = 0; a < this.combinedDataAfterExtractionSourceResponse.length; a++) {
            ...
            if (this.combinedDataAfterExtractionSourceResponse[a].key.includes(this.combinedDataAfterExtractionSourceResponse[u].key) && (this.combinedDataAfterExtractionSourceResponse[u].value == "array")) {


              var newValue = this.combinedDataAfterExtractionSourceResponse[u].key.replace(".type", "")
  ...
  async yamlCreation(requestD, responseD, clientUrl) {
    ...
    this.mappingService.postYamlData(yamlObject).then((yamlResponse) => {
      ...
      var mapping4RequestDataObject = {
        "iSureMapping2RequestObject1": this.iSureMapping2RequestObject1,
        "iSureMapping2ResponseObject1": this.iSureMapping2ResponseObject1,
        "iSureMapping2RequestObject2": this.iSureMapping2RequestObject2,
        "iSureMapping2ResponseObject2": this.iSureMapping2ResponseObject2,
      };
        ...
        if (this.combinedDataAfterExtractionSource2[u].key.includes(this.dataWithDirectRowNo2[y].sourceFieldName)) {
          ...
          for (var a = 0; a < this.combinedDataAfterExtractionSource2.length; a++) {
            ...
            if (this.combinedDataAfterExtractionSource2[a].key.includes(this.combinedDataAfterExtractionSource2[u].key) && (this.combinedDataAfterExtractionSource2[u].value == "array")) {
              ...
              var value1 = this.combinedDataAfterExtractionSource2[u].key.replace(".type", "")
  ...
  */
  ...
  getFlattenStructureResponse12() {
    ...
    this.mappingService.postESQL(finalEsqlObject_2).then((dataEsql) => {

      console.log(" 2nd response")
      console.log("response dataEsql = ", dataEsql)

      // this.toastr.success("Response for ESQL Accept :" + dataEsql.message);
      this.msg=dataEsql.message
      $("#e").css("display","block").delay(2000).fadeOut(200);

      console.log("3rd response")
      this.mappingService.postESQL(finalEsqlObject_3).then((dataEsql) => {

        console.log("response dataEsql = ", dataEsql)

        // this.toastr.success("Response for ESQL Reject :" + dataEsql.message);


        this.mappingService.postESQL(finalEsqlObject_4).then((dataEsql) => {
  ...
  */
  ...
  async yamlCreation2(requestD, responseD, clientUrl) {
    ...
    var yamlObject = {
      ...
      'fileName': config.fileNameYaml_Scene_4,
      "username": this.username,
      "orgName": this.organisation,
      "productName": this.productName,
      "serviceName": this.serviceName,
